[![GoDoc](https://godoc.org/github.com/ork-io/go-xml?status.svg)](https://godoc.org/github.com/ork-io/go-xml) [![Build Status](https://travis-ci.org/droyo/go-xml.svg?branch=master)](https://travis-ci.org/droyo/go-xml)
...
```
go get github.com/ork-io/go-xml/...
```
